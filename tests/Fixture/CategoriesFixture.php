...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'categories_fk0' => ['type' => 'index', 'columns' => ['parent_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'categories_fk0' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_delete' => 1,
                'modified' => '2018-11-22 17:19:05',
                'created' => '2018-11-22 17:19:05'
            ],
        ];
        parent::init();
    }

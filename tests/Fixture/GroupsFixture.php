...
class GroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2018-11-08 16:18:36',
                'modified' => '2018-11-08 16:18:36'
            ],
        ];
        parent::init();
    }

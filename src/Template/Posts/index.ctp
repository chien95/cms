    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('info_text1') ?></th>
                <th scope="col"><?= $this->Paginator->sort('info_text2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('info_text3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('info_number1') ?></th>
                <th scope="col"><?= $this->Paginator->sort('info_number2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('info_number3') ?></th>
